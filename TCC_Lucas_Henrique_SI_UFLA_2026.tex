...
% \destacarfalse para gerar versao com marcacao amarela; \destacartrue para versao limpa.
\newif\ifdestacar
\destacarfalse
...
\newcommand{\novop}[1]{\ifdestacar
  \par\noindent\colorbox{yellow!50}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep\relax}#1\end{minipage}}\par\vspace{4pt}
  \else
  \par #1\par
  \fi}
