...
\includegraphics[width=0.95\textwidth]{imgs/tela-protocolo-avaliacoes.png}
\fonte{\novo{do autor (2026).}}
\end{figure}
...
\includegraphics[width=0.95\textwidth]{imgs/tela-orcamento-formulario.png}
\fonte{\novo{do autor (2026).}}
\end{figure}
...
\novop{A \autoref{fig:tela-graficos} apresenta o resultado da geração automatizada dos gráficos de barras a partir dos dados de uma avaliação, e a \autoref{fig:tela-exportacao} ilustra a imagem exportada em PNG já com o logotipo da empresa cliente.}

\begin{figure}[ht]
\centering
\caption{\novo{Gráficos de barras gerados automaticamente para uma avaliação.}}
\label{fig:tela-graficos}
\includegraphics[width=0.95\textwidth]{imgs/tela-graficos-barras.png}
\fonte{\novo{do autor (2026).}}
\end{figure}
...
\includegraphics[width=0.7\textwidth]{imgs/tela-graficos-exportacao.png}
\fonte{\novo{do autor (2026).}}
\end{figure}
